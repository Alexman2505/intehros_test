...
app = Flask(__name__)
app.config['UPLOAD_FOLDER'] = '/home/alexman2505/flask_cat_app/static/uploads'
...
MODEL_PATH = '/home/alexman2505/flask_cat_app/best.onnx'
...
def run_inference(image_bytes, conf_thres=0.5):
    ...
    Пример использования:
        ...
        >>> result_image.save('annotated_cat.jpg')

    Примечания:
        - Модель обучена только на одном классе ('cat-tail').
